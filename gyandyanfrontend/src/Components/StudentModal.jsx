...
export default function StudentModal(props) {
    ...
    const acceptinvite = (id) => {
        httpClient
        .get(`RequirementTranscation/accept-invite/${id}`)
        .then((res) => {
    ...
    const rejectInvite = (id) => {
        httpClient
        .get(`RequirementTranscation/reject-invite/${id}`)
        .then((res) => {
            setmessage(res.data)
        });
    }
            ...
            <div className="modal fade" id="exampleModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                <div className="modal-dialog modal-dialog-centered" role="document">
                    ...
                    <div className="modal-header">
                        <h5 className="modal-title" id="exampleModalLongTitle">Your Invites</h5>
