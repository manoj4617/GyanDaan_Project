                                    ...
                                    <div className="d-flex justify-content-between">
                                        <div className="d-flex flex-row align-items-center">
                                            <div className="ms-2 c-details">
                                                <h6 className="mb-0">{item.oneToOnes.studentProfile.firstName} {item.oneToOnes.studentProfile.lastName}</h6> 
                                                <span className="font-weight-light">{item.oneToOnes.studentProfile.email}<br/>
                                                {item.oneToOnes.studentProfile.mobileNumber}</span>
                                            </div>
                                        </div>
                                        <div className="badge"> <span>Tutoring</span> </div>
                                    </div>
                                    <div className="mt-0">
                        ...
                        {item.typeOfClass === 1 ? (
                            <div className="col-lg-8">
                                <div className="card class-card p-3">
                                    <div className="d-flex justify-content-between">
                                        <div className="d-flex flex-row align-items-center">
                                            <div className="ms-2 c-details">
                                                ...
                                                <span className="font-weight-light">{item.topic}</span>
                                            </div>
                                        </div>
                                        <div className="badge"> <span>Tutoring</span> </div>
                                    </div>
                                    ...
                                    <h4>Students Enrolled <span className="font-italic"> {item.inGroupVolunteer.length}</span></h4>
                                    ...
                                    <ul style={{"marginTop" : "-18px"}}>
                                            <li>
                                                <span className="font-weight-bold">{groupItem.studentProfile.firstName} {groupItem.studentProfile.lastName}</span> <br/>
                                                    <span className="item-except text-muted text-sm h-1x">{groupItem.studentProfile.email} | {groupItem.studentProfile.mobileNumber}
                                                </span>
                                            </li>
                                     </ul>
                                    ))}
