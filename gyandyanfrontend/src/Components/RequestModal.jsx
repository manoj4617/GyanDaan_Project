...
export default function RequestModal(props) {
  ...
  const sendInvite = (studentRequirementId, volunteerRequirementId) => {
    httpClient
      .get(
        `RequirementTranscation/send-inviteTo-student/${studentRequirementId}/${volunteerRequirementId}`
      )
      .then((res) => {
        ...
        <div className="modal-dialog modal-dialog-centered" role="document">
          ...
          >
            <div className="modal-header">
              <h5 className="modal-title text-black" id="ModalLongTitle">
                You can Invite to these requirement
              </h5>
              <button
                type="button"
                className="close"
                    ...
                    <div className="card" style={{ width: "24rem" }}>
                      ...
                      >
                        ...
                        <p className="card-text">
                          Class type : {typeOfClass[item.typeOfClass]}
                        </p>
                        <button
                          className="card-link btn btn-warning"
                          onClick={() =>
                            sendInvite(props.studentRequirementId, item.id)
                          }
                        >
                          Invite
                        </button>
